...
import conctactsControllers from "../controllers/contactsControllers.js";
import {
  createContactSchema,
  updateContactSchema,
...
contactsRouter.post(
  "/",
  conctactsControllers.createContact,
...
contactsRouter.put(
  "/:id",
  isValidId,
  conctactsControllers.updateContact,
...
contactsRouter.patch(
  "/:id/favorite",
  isValidId,
  conctactsControllers.updateStatusContact,
